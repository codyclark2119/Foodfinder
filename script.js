            ...
            $("#submit").click(function(event) {
                ...
                var urlLink = "https://api.foursquare.com/v2/venues/search?near=" + locationSearch + "&categoryId=" + categoryType + "&limit=20" + "&client_id=" + clientId + "&client_secret=" + clientSecret + "&v=20182107";
